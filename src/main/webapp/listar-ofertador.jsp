	...
	<div id="content-wrapper" class="d-flex flex-column">
		...
		<div id="content">
					...
					<li class="nav-item dropdown no-arrow"><a
						...
						<div
							...
							<a class="dropdown-item" href="/turismoHDR/logout"
								data-toggle="modal" data-target="#ComprarModal"> <i
			...
			<div class="container-fluid m-5">
				...
				<div class="row p-0 row-cols-12 row-cols-xl-10">
				
					<c:forEach items="${ofertables}" var="ofertable">
						<div class="card  ms-4 mt-2 mb-2 me-3 fw-bolder text-center shadow-sm" style="width: 20rem;  ">
							<img src=""   class="card-img-top pt-1 " width="200"  alt="...">
							<div class="card-body">
								<h5 class="card-title">
									<c:out value="${ofertable.nombre}"></c:out>
								</h5>
								
								<h6 class="card-text">
								Tipo:<br>
								<c:out value="${ofertable.tipo}"></c:out>
							</h6>
							<h6 class="card-text">
								Monto:<br>
								<c:out value="${ofertable.monto}"></c:out>
							</h6>
							<h6 class="card-text">
								Tiempo<br>
								<c:out value="${ofertable.tiempo}"></c:out>
							</h6>
							<h6 class="card-text">
								Atracciones incluidas:<br>
								<c:out value="${ofertable.packAtracciones[0]}"></c:out>
							</h6>
							<h6 class="card-text">
								<c:out value="${ofertable.packAtracciones[1]}"></c:out>
							</h6>
							<h6 class="card-text">
								<c:out value="${ofertable.atraccionGratis}"></c:out>
							</h6>
							<h6 class="card-text">
								Descuento:<br>
								<c:out value="${ofertable.descuento}"></c:out>
							</h6>
							...
							<div class="card-body">
								<c:choose>
									<c:when
										test="${usuario.puedeComprar(ofertable) && usuario.puedeAsistir(ofertable) && ofertable.puedeAlbergar(1)}">
										<a href="comprar.do?id=${ofertable.id}"
