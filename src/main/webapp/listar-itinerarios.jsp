			...
			<!-- FIN BARRA DE ARRIBA -->
				...
				<div class="container-fluid">
                    ...
                    <div id="itinerario-oculto" class="row row-cols-12 row-cols-xl-12">
                        <h2 class="fw-bolder display-4 mb-3 ">Itinerarios</h2>
                        <div class="col-lg-12">
                            <table id="itinerario" class="table  table-bordered table-white  table-hover"
                                ...
                                <c:forEach items="${itinerarios}" var="itinerario">
                                    <tr>
                                        <td><c:out value="${itinerario.ofertable}"></c:out></td>
                                        <td><c:out value="${itinerario.id}"></c:out></td>
                                        <td><c:out value="${itinerario.usuario}"></c:out></td>
